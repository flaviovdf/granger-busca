 ...
 */
  ...
  __Pyx_WriteUnraisable("gb.stamps.Timestamps.find_previous", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_r = 0;
  __pyx_L0:;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gb.stamps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
