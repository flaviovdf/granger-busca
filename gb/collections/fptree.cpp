...
static void __pyx_f_2gb_11collections_6fptree_6FPTree__build(struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self, size_t __pyx_v_size); /* proto*/
...
static const char __pyx_k_Incompatible_checksums_s_vs_0xd5[] = "Incompatible checksums (%s vs 0xd5094f7 = (size, values))";
...
static PyObject *__pyx_int_223384823;
...
static void __pyx_f_2gb_11collections_6fptree_6FPTree__build(struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self, size_t __pyx_v_size) {
 ...
 */
  __pyx_t_2 = __pyx_v_self->values.size();
 ...
 * 
 */
  __pyx_t_1 = ((size_t)__pyx_v_self->values.size());
 ...
 * 
 */
  __pyx_v_t_pos = ((size_t)(__pyx_v_self->values[0]));
...
static PyObject *__pyx_pw_2gb_11collections_6fptree_6FPTree_5_get_value(PyObject *__pyx_v_self, PyObject *__pyx_arg_i) {
  ...
  assert(__pyx_arg_i); {
    __pyx_v_i = __Pyx_PyInt_As_size_t(__pyx_arg_i); if (unlikely((__pyx_v_i == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 76, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(((struct __pyx_vtabstruct_2gb_11collections_6fptree_FPTree *)__pyx_v_self->__pyx_vtab)->get_value(__pyx_v_self, __pyx_v_i)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 77, __pyx_L1_error)
...
static PyObject *__pyx_pw_2gb_11collections_6fptree_6FPTree_7_set_value(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_set_value (wrapper)", 0);
  {
    ...
    __pyx_v_i = __Pyx_PyInt_As_size_t(values[0]); if (unlikely((__pyx_v_i == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 88, __pyx_L3_error)
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_FromSize_t(((struct __pyx_vtabstruct_2gb_11collections_6fptree_FPTree *)__pyx_v_self->__pyx_vtab)->sample(__pyx_v_self, __pyx_v_urnd)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 103, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __pyx_convert_vector_to_py_double(__pyx_v_self->values); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 3, __pyx_L1_error)
 ...
 *         use_setstate = False             # <<<<<<<<<<<<<<
 *     if use_setstate:
 *         return __pyx_unpickle_FPTree, (type(self), 0xd5094f7, None), state
 */
  /*else*/ {
 ...
 *         return __pyx_unpickle_FPTree, (type(self), 0xd5094f7, None), state             # <<<<<<<<<<<<<<
 *     else:
 *         return __pyx_unpickle_FPTree, (type(self), 0xd5094f7, state)
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_pyx_unpickle_FPTree); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 11, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __Pyx_INCREF(__pyx_int_223384823);
    __Pyx_GIVEREF(__pyx_int_223384823);
    PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_int_223384823);
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_pyx_unpickle_FPTree); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 *     if __pyx_checksum != 0xd5094f7:             # <<<<<<<<<<<<<<
 *         from pickle import PickleError as __pyx_PickleError
 *         raise __pyx_PickleError("Incompatible checksums (%s vs 0xd5094f7 = (size, values))" % __pyx_checksum)
 */
  __pyx_t_1 = ((__pyx_v___pyx_checksum != 0xd5094f7) != 0);
  if (__pyx_t_1) {
 ...
 *     return __pyx_result             # <<<<<<<<<<<<<<
 * cdef __pyx_unpickle_FPTree__set_state(FPTree __pyx_result, tuple __pyx_state):
 *     __pyx_result.size = __pyx_state[0]; __pyx_result.values = __pyx_state[1]
 */
  __Pyx_XDECREF(__pyx_r);
 ...
 */
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_stringsource, __pyx_n_s_pyx_unpickle_FPTree, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_InitGlobals(void) {
  ...
  __pyx_int_223384823 = PyInt_FromLong(223384823L); if (unlikely(!__pyx_int_223384823)) __PYX_ERR(0, 1, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
#endif
{
  ...
  __pyx_vtable_2gb_11collections_6fptree_FPTree._build = (void (*)(struct __pyx_obj_2gb_11collections_6fptree_FPTree *, size_t))__pyx_f_2gb_11collections_6fptree_6FPTree__build;
