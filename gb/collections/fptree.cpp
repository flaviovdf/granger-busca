...
static int __pyx_pf_2gb_11collections_6fptree_6FPTree___cinit__(struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self, int __pyx_v_size, double __pyx_v_init_value); /* proto */
static PyObject *__pyx_pf_2gb_11collections_6fptree_6FPTree_2__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_2gb_11collections_6fptree_6FPTree_4__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state); /* proto */
...
static int __pyx_pw_2gb_11collections_6fptree_6FPTree_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_size;
  double __pyx_v_init_value;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_size,&__pyx_n_s_init_value,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_init_value);
    ...
    __pyx_v_size = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 38, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_init_value = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_init_value == (double)-1) && PyErr_Occurred())) __PYX_ERR(1, 38, __pyx_L3_error)
    } else {
      __pyx_v_init_value = ((double)0.0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 38, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gb.collections.fptree.FPTree.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_2gb_11collections_6fptree_6FPTree___cinit__(((struct __pyx_obj_2gb_11collections_6fptree_FPTree *)__pyx_v_self), __pyx_v_size, __pyx_v_init_value);
...
static int __pyx_pf_2gb_11collections_6fptree_6FPTree___cinit__(struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self, int __pyx_v_size, double __pyx_v_init_value) {
  int __pyx_v_t_pos;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
 ...
 */
  __pyx_v_self->values.assign((2 * __pyx_v_t_pos), __pyx_v_init_value);
...
/* Python wrapper */
static PyObject *__pyx_pw_2gb_11collections_6fptree_6FPTree_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_2gb_11collections_6fptree_6FPTree_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_2gb_11collections_6fptree_6FPTree_2__reduce_cython__(((struct __pyx_obj_2gb_11collections_6fptree_FPTree *)__pyx_v_self));
...
static PyObject *__pyx_pf_2gb_11collections_6fptree_6FPTree_2__reduce_cython__(CYTHON_UNUSED struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self) {
...
/* Python wrapper */
static PyObject *__pyx_pw_2gb_11collections_6fptree_6FPTree_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_2gb_11collections_6fptree_6FPTree_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_2gb_11collections_6fptree_6FPTree_4__setstate_cython__(((struct __pyx_obj_2gb_11collections_6fptree_FPTree *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_2gb_11collections_6fptree_6FPTree_4__setstate_cython__(CYTHON_UNUSED struct __pyx_obj_2gb_11collections_6fptree_FPTree *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
...
static PyMethodDef __pyx_methods_2gb_11collections_6fptree_FPTree[] = {
  {"__reduce_cython__", (PyCFunction)__pyx_pw_2gb_11collections_6fptree_6FPTree_3__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_2gb_11collections_6fptree_6FPTree_5__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "gb.collections.fptree")) {
      if (unlikely(PyDict_SetItemString(modules, "gb.collections.fptree", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (PyType_Ready(&__pyx_type_2gb_11collections_6fptree_FPTree) < 0) __PYX_ERR(1, 36, __pyx_L1_error)
  __pyx_type_2gb_11collections_6fptree_FPTree.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_2gb_11collections_6fptree_FPTree.tp_dict, __pyx_vtabptr_2gb_11collections_6fptree_FPTree) < 0) __PYX_ERR(1, 36, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "FPTree", (PyObject *)&__pyx_type_2gb_11collections_6fptree_FPTree) < 0) __PYX_ERR(1, 36, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_2gb_11collections_6fptree_FPTree) < 0) __PYX_ERR(1, 36, __pyx_L1_error)
