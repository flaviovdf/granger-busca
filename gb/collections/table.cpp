 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 166, __pyx_L1_error)
 ...
 *         rh_init(self.table, load_factor)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Robin_Hash_out_of_mem); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 166, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gb.collections.table", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
